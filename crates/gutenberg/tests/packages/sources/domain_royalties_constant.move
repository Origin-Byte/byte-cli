module gutenberg::domainroyaltiesconstant {
    /// One time witness is only instantiated in the init method
    struct DOMAINROYALTIESCONSTANT has drop {}
    ...
    fun init(witness: DOMAINROYALTIESCONSTANT, ctx: &mut sui::tx_context::TxContext) {
        let (mint_cap, collection) = nft_protocol::collection::create(&witness, ctx);
        let delegated_witness = nft_protocol::witness::from_witness<DOMAINROYALTIESCONSTANT, Witness>(&Witness {});

        nft_protocol::collection::add_domain(
            delegated_witness,
            &mut collection,
            nft_protocol::creators::from_address<DOMAINROYALTIESCONSTANT, Witness>(
    ...
    public entry fun collect_royalty<FT>(
        payment: &mut nft_protocol::royalties::TradePayment<DOMAINROYALTIESCONSTANT, FT>,
        collection: &mut nft_protocol::collection::Collection<DOMAINROYALTIESCONSTANT>,
    ...
    public entry fun mint_to_address(
        ...
        url: vector<u8>,
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINROYALTIESCONSTANT>,
        receiver: address,
        ctx: &mut sui::tx_context::TxContext,
    ) {
        let nft = mint(
    ...
    fun mint(
        ...
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINROYALTIESCONSTANT>,
        ctx: &mut sui::tx_context::TxContext,
    ): nft_protocol::nft::Nft<DOMAINROYALTIESCONSTANT> {
