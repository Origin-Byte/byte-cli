module gutenberg::domainempty {
    /// One time witness is only instantiated in the init method
    struct DOMAINEMPTY has drop {}
    ...
    fun init(witness: DOMAINEMPTY, ctx: &mut sui::tx_context::TxContext) {
        let (mint_cap, collection) = nft_protocol::collection::create(&witness, ctx);
        let delegated_witness = nft_protocol::witness::from_witness<DOMAINEMPTY, Witness>(&Witness {});

        nft_protocol::collection::add_domain(
            delegated_witness,
            &mut collection,
            nft_protocol::creators::from_address<DOMAINEMPTY, Witness>(
    ...
    public entry fun mint_to_launchpad(
        ...
        url: vector<u8>,
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINEMPTY>,
        warehouse: &mut nft_protocol::warehouse::Warehouse<DOMAINEMPTY>,
    ...
    fun mint(
        ...
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINEMPTY>,
        ctx: &mut sui::tx_context::TxContext,
    ): nft_protocol::nft::Nft<DOMAINEMPTY> {
