module gutenberg::domainurl {
    ...
    fun init(witness: DOMAINURL, ctx: &mut sui::tx_context::TxContext) {
        ...
        let delegated_witness = nft_protocol::witness::from_witness<DOMAINURL, Witness>(&Witness {});
    ...
    public entry fun mint_to_launchpad(
        ...
        url: vector<u8>,
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINURL>,
        warehouse: &mut nft_protocol::warehouse::Warehouse<DOMAINURL>,
    ...
    fun mint(
        ...
        mint_cap: &nft_protocol::mint_cap::MintCap<DOMAINURL>,
        ctx: &mut sui::tx_context::TxContext,
    ): nft_protocol::nft::Nft<DOMAINURL> {
